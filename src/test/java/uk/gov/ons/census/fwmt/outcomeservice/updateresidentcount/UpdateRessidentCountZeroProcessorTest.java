...
public class UpdateRessidentCountZeroProcessorTest {
  ...
  public void shouldUpdateSiteResidentCountToZero() throws GatewayException, ParseException, JSONException {
    ...
    when(eventDictionaryMessageFactory.buildFieldCaseUpdated(anyString(), any(Integer.class))).thenReturn(
        "{\"payload\":{\"fieldCaseUpdate\":{\"caseId\":\""
    ...
    JSONObject collectionCase = jsonObject.getJSONObject("payload").getJSONObject("fieldCaseUpdate");
    String siteId = collectionCase.get("caseId").toString();
